      ...
      <div class="login-card">
        ...
        <div class="login-header">
          ...
          <h1 class="login-title">
            Pedidos<span class="text-orange">360</span>
          </h1>
          <p class="login-subtitle">
            Plataforma Cloud Native de Pedidos Gastronómicos. Inicia sesión con
            tu cuenta institucional o de Microsoft Azure AD.
          </p>
        </div>
        ...
        @if (authService.isDemoMode()) {
          <div class="demo-box">
            ...
            <p class="demo-text">
              Para calificar y probar los endpoints del backend y las rutas
              protegidas sin configurar un Tenant real de Azure, selecciona un
              perfil:
            </p>
  ...
  styles: [
    `
      ...
      .login-card {
        ...
        border-radius: 20px;
        box-shadow:
          0 20px 35px -10px rgba(15, 23, 42, 0.1),
